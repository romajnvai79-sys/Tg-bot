...
# ================= CONFIG =================
BOT_TOKEN = os.getenv("BOT_TOKEN", "8226351090:AAH5BAcW_zQHXJnzLdMr2KtJHUySfVW8idw")
ADMIN_ID = int(os.getenv("ADMIN_ID", "6676376793"))
CLONED_BOT = os.getenv("CLONED_BOT", "false").lower() == "true"
MAX_FREE_BOTS = 3
PORT = int(os.getenv("PORT", 57839))  # Default port 8080
...
@app.route('/')
def home():
    return "🚀 Ax Romjan Hosting Bot is running!", 200
...
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
    🚀 Ax Romjan Hosting Bot is RUNNING!
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def premium_menu(user_id):
    ...
    markup.row(types.InlineKeyboardButton("👤 Contact Owner @axromjanhossain", url="https://t.me/axemoteserver"))
...
def start(message):
    ...
    user_info_text = (
        ...
        f"👤 **Username:** {username}\n"
        f"📝 **Bio:** {bio}\n\n"
        f"Ax Romjan Hosting Bot is a Telegram bot that makes managing your hosting and servers easy. "
...
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
  ...
  ✨ "Empowering your code with elite performance" """
        ...
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Message Owner", url="https://t.me/axromjanhossain"))
...
✨ Bot is running smoothly!"""
        ...
        if data_parts[0] == "ADM":
            ...
            if action == "FILE_MAN":
                ...
                save_data(BLOCK_FILE, blocked_users)
                try:
                    bot.send_message(t, "🚫 You have been blocked by an admin. Contact @axromjanhossain for help.")
                except:
                    pass
            ...
            if token not in clone_requests:
                ...
                try:
                    bot.send_message(user_id_req, f"😞 **Your clone request was rejected.**\n\n"
                                                 f"**Bot:** `@{safe_markdown(bot_name)}`\n\n"
                                                 f"Contact @axromjanhossain for questions.", parse_mode="Markdown")
                except:
                    pass
